...
import { PRODUCT } from "../_data/arcgisDocs";

// Belt and braces: every slug in the data file is prerendered, so this only
// shows if the add-in ships a Help button for a tool whose page is not written
// yet. Better a signposted page than a bare 404 on a Help button.
    ...
    <main className="pt-32 pb-20">
      <div className="custom-screen max-w-2xl text-center">
        ...
        <p className="mb-8 leading-relaxed text-brand-text/70 dark:text-gray-300">
          ឯកសារណែនាំសម្រាប់ឧបករណ៍នេះមិនទាន់មានទេ។ សូមមើលបញ្ជីឧបករណ៍ទាំងអស់ ឬទាក់ទងផ្នែកជំនួយ។
        </p>
